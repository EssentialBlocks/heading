	...
	class EbStyleHandler
	{
		...
		public function essential_blocks_edit_post($hook)
		{
			...
			if ($hook == 'post-new.php' || $hook == 'post.php') {
				...
				wp_enqueue_script('essential-blocks-edit-post', plugins_url($frontend_js, __FILE__), array("jquery", "wp-editor"), '1.1.0', true);
			}
		}
		 ...
		 * @since 1.0.2
		 */
		private function build_css($style_object): string
		{
